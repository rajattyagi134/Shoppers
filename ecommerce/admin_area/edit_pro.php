...
<tr align="center">
<td colspan="7"><h2><b>Edit & Update Product</b></h2></td>
</tr>
...
if(isset($_POST['update_product'])){
	...
	move_uploaded_file($product_image_tmp,"product_images/$product_image");
	  ...
	  $update_product = "update_product set product_cat='$product_cat',product_brand='$product_brand',product_title='$product_title', product_price='$product_price', product_desc='$product_desc', product_image='$product_image', product_keywords='$product_keywords' where product_id='$update_id'";
